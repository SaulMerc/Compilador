...
public class tools {
    ...
    public String buscarInfo(String rule) throws FileNotFoundException {
        Scanner in = null;
        String rl, info, rtn = "n";

        try {
            in = new Scanner(new FileReader("infoReg.txt"));
            while (in.hasNextLine()) {
                info = in.nextLine();
    ...
    /**
     * Método para crear el árbol de derivación
     */
    public void arbolote() {
        ...
        while ( i >= 0) {
            ...
            }else if(Integer.parseInt(arbolito.get(i)) == 24){
